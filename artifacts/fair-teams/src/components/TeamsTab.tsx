    ...
    <div className="flex flex-col gap-3">
      ...
      <div className="bg-card border border-border px-3 py-2.5 rounded-xl shadow-sm flex flex-col gap-2">
        <div className="grid grid-cols-2 md:grid-cols-[1fr_1fr_auto] gap-2">
          ...
          <Button
            className={`h-10 px-4 font-black uppercase tracking-wide text-[13px] shadow-sm bg-[#22C55E] text-white hover:bg-[#16A34A] transition-all ${isGenerating ? "ring-4 ring-emerald-300/45 shadow-lg shadow-emerald-400/25" : ""}`}
